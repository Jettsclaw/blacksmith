# BUILD CONTRACT — Blacksmith Barbers & Academy

This repo builds the Blacksmith website, funnels and content. Follow this contract on every build. It exists so the skill can never be skipped or misread.
...
A premium, dark-editorial site/funnel — not a generic template. Match the standard of the Waterbenders repo. Use real photos (the shop's own).

## Output
`index.html` is the showcase hub; each build is its own page inside the repo. New builds drop in as another card.
