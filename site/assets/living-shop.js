...
(function () {
  ...
  var BARBER_NAMES = ['bayli','ben','cam','cristian','jarred','jayden','johnnatan','locky','mubarak','sami','sophie'];
  ...
  function draw(t) {
    ...
    if (snap) {
      ...
      if (hostAsk && hostAsk.shop) { // shop cabinet confirm — keep the Yes/No fork
        ...
        ctx.font = '700 22px Oswald, sans-serif';
        ctx.textAlign = 'center';
        var opts = [{ t: 'Walk-In’s', a: 'q', g: true }, { t: 'Bookings', a: 'bk', g: false }, { t: 'Shop', a: 'sh', g: false }];
        var gap = 10, bh2 = 40;
