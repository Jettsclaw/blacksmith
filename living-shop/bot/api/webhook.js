...
// Read state via head()->downloadUrl: that URL is version-pinned, so it returns the
// freshly-written value (the public path URL is CDN-cached and serves stale copies).
